    ...
    render(){
        return(
            <div class="container p-4">
                ...
                <form action="http://localhost:4000/api/usuario" method="POST" class="form-inline">
                    ...
                    <div class="form-group col-5">
                        ...
                        <input name="telefono" class="form-control" placeholder="Ingresa tu numero.." type="text" required></input>
                    </div>
                    <div class="form-group col-5">
                        <label>Domicilio:</label>
                        <input name="direccion" class="form-control" placeholder="Ingresa tu direccion.." type="text" required></input>
                    </div>
                    <div class="form-group col-5">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="M" name="sexo" class="custom-control-input"></input>
                        <label class="custom-control-label" for="M">Masculino</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="F"name="sexo" class="custom-control-input"></input>
                        <label class="custom-control-label" for="F">Femenino</label>
                    </div>
                    <div class="form-group col-5">
                        <label>Crear usuario:</label>
                        <input name="usuario" class="form-control" placeholder="Ingrese usuario.." type="text" required></input>
                    </div>
                    
                    <div class="form-group col-5">
                        <label>Crear contraseña: </label>
                        <input name="contraseña" class="form-control" placeholder="Ingrese contraseña.." type="password" required></input>
